...
import 'package:nu_laundry/return.dart';
...
TextEditingController _numberbox=TextEditingController();
 ...
 appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Return-Laundry",style: TextStyle(color: Colors.white),),
...
Navigator.push(context, MaterialPageRoute(builder: (context)=>Return(usercode: int.parse(_numberbox.text),)));
