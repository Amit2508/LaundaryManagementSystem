...
class viewlaundry extends StatefulWidget {
...
viewlaundry({this.usercode});

  @override
  State<viewlaundry> createState() => _viewlaundryState();
}

class _viewlaundryState extends State<viewlaundry> {
 ...
 if(_userfound){
     return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Up coming ",style: TextStyle(color: Colors.black),),
